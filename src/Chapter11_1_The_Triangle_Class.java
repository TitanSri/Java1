 ...
 */
public class Chapter11_1_The_Triangle_Class {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Enter in three sides for the Triangle: ");
        double side1 = input.nextDouble();
        double side2 = input.nextDouble();
        double side3 = input.nextDouble();
        
        // Prompt the user to enter a color (american class)
        System.out.println("Enter a color to fill the trianlge: ");
        String color = input.next();
        
        // Prompt the user to enter whether the triangle is fill or not
        System.out.println("Is the triangle filled (true / fales): ");
        ...
        System.out.println("Trianlge is" + (triangle.isFilled() ? "" : " not ") + " filled");
    }
}
